...
let details = {
    student_name:'Grace Hannah Park',
    font_name:'on/off_Grid',
    description:'Playful interactive typeface using checkerboard grid, fading, existing, inverting, on and off!',
}
