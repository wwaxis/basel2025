...
let details = {
    student_name:'Jules Hoogkamer',
    font_name:'Nondial',
    description:'Nondial is a variable type experiment inspired by the winds circulating the atmosphere.',
}
...
const config = {
    ...
    minWeight: 100,        // Minimum value for 'wght' axis (font weight)
    maxWeight: 900,        // Maximum value for 'wght' axis (font weight)
